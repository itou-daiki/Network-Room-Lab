...
export const ROLE_PRACTICES: RolePracticeDefinition[] = [
  {
    ...
    choices: [
      ...
      { id: "pc-arp-gateway", label: "ARPを使い、192.168.10.1に対応するルータのMACアドレスを調べる", correct: true, feedback: "正解です。ARPは質問相手ではなく、IPv4アドレスから同じLAN内のMACアドレスを調べる仕組みです。PCは出口のルータへフレームを渡すため、192.168.10.1に対応するMACアドレスを調べます。" },
    ...
    successOutput: [
      ...
      "ルータからのARP応答：192.168.10.1を使っているのは私です。私のMACアドレスは02-00-00-00-10-01です",
    ...
    successMeanings: [
      ...
      "ARPは質問相手ではなく、IPアドレスからMACアドレスを調べる仕組みです。PCはこの問い合わせを同じLAN内の全機器へ送ります。",
      "192.168.10.1はルータのLAN側IPアドレスです。そのIPアドレスを使うルータだけが、自分のMACアドレスを答えました。",

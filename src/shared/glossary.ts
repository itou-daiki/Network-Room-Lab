...
export const NETWORK_GLOSSARY: NetworkTerm[] = [
  ...
  { id: "dns", label: "DNS", reading: "ディーエヌエス", short: "ドメイン名をIPアドレスへ変換する仕組み。", detail: "人が覚えやすい名前と、機器が通信に使うIPアドレスを対応付けます。", example: "この学習モデルでは www.mext.go.jp → 203.0.113.80 と調べます。", category: "通信" },
  { id: "domain", label: "ドメイン名", short: "人が覚えやすい、ネットワーク上の名前。", detail: "通信前にDNSへ問い合わせ、対応するIPアドレスを得ます。", example: "www.mext.go.jp のような名前です。", category: "アドレス" },
  ...
  { id: "tcp", label: "TCP", reading: "ティーシーピー", short: "相手と通信路を準備し、データが順番どおり届くようにする仕組み。", detail: "送る前にWebサーバと接続を作り、届かなかったデータがあれば送り直します。", example: "学習指導要領ページを要求する前に、PCとWebサーバの間にTCPの通信路を準備します。", category: "通信" },
  ...
  { id: "http", label: "HTTP", reading: "エイチティーティーピー", short: "PCがWebページを求め、Webサーバが結果とページ内容を返すための決まり。", detail: "PCは「何をしてほしいか」と「どのページか」を伝えます。Webサーバは、処理できたかを表す番号とページ内容を返します。", example: "GET / は「トップページをください」、200 OKは「正常に用意できました」という意味です。", category: "通信" },
  ...
  { id: "ipconfig", label: "ipconfig", reading: "アイピーコンフィグ", short: "PC自身のネットワーク設定を表示する確認コマンド。", detail: "学習指導要領ページへ送る準備ができているかを調べるために、PCのIPアドレス・同じネットワークの範囲・外部への出口・DNSサーバを確認します。", example: "まずipconfigを実行し、4項目がこの実習の設定と一致するかを上から順に見ます。", category: "調査コマンド" },

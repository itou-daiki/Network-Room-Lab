...
「特定のWebサイトにある教材ページを見る」という大きな目的に向かって、情報ネットワークを役割ごとに動かす体験型Webアプリケーションです。一人なら6つの機器を順番に、授業では仲間と役割分担して、Webページが表示されるまでの通信と原因調査を体験できます。
...
- 「DNSサーバへIPアドレスを聞く往復」と「Webサーバへ教材ページを取りに行く往復」を、行き・帰り・現在地付きで示す詳細な経路図
